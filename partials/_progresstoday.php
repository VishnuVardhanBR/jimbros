<?php $dayhtml = '<div class="container my-5 pb-5">
    <div class="row mb-3">
        <div class="col-8"><div class="col">
                <h1 class="display-1 fw-bold">Today, <h1 class="display-4 fw-soft">' . $td2 . '</h1>
                </h1>
            </div>
            ...
            <div class="col d-flex align-items-start mt-5">
                ...
                <div>
                    <h1>Burnt ' . $dres['calorieburn'] . ' Calories</h1>
                </div>
            </div>
            <div class="col d-flex align-items-start mt-5">
                <div class="icon flex-shrink-0 me-3">
                ...
                <div>
                    <h1>Worked out for ' . $dres["workouttime"] . ' Minutes</h1>
                </div>
            </div>'
?>
<?php if ($mgrouplogged && !$daylogged) {

    echo '<div class="container my-5 pb-5">
                <div class="row mb-3">
                    <div class="col-8"><div class="col">
                <h1 class="display-1 fw-bold">Today, <h1 class="display-4 fw-soft">' . $td2 . '</h1>
                </h1>
...
} else if ($daylogged && !$mgrouplogged) {

    echo $dayhtml . '</div>
    </div>
    </div><div class="b-example-divider my-5"></div>';
} else if ($daylogged && $mgrouplogged) {
